...
print('Staff version with histogram (vertical histogram and input progression data extension) \n')
...
def main():
    ...
    try:
        ...
        #storing progression data in a list 
        temp_inputs = []
        temp_inputs.extend([ f'{progress_outcome} - {cr_pass}, {cr_defer}, {cr_fail}'])
        progression_data.extend(temp_inputs)
